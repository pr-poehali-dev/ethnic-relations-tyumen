    ...
    <div className="min-h-screen" style={{ backgroundColor: "var(--ac-bg)", color: "var(--ac-dark)" }}>
          ...
          <div className="flex items-center justify-between py-3">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xs font-semibold leading-tight" style={{ color: "var(--ac-dark)" }}>ТИУ · ПИНб-25-1</p>
              </div>
            </div>
          ...
          <div className="space-y-6">
            ...
            <div className="rounded-lg p-6 bg-white" style={{ border: "1px solid var(--ac-border)" }}>
              ...
              <p className="text-xs text-center mt-3" style={{ color: "var(--ac-muted)" }}>
                Источник: социологический опрос, ТИУ, 2023 г., n = 1 200
              </p>
            </div>
          </div>
        </section>
        ...
        <section id="statistics" className="scroll-mt-20">
          ...
          <div className="space-y-8">
            ...
            <div className="rounded-lg p-6 bg-white" style={{ border: "1px solid var(--ac-border)" }}>
              ...
              <StackedBar />
              <p className="text-xs mt-4" style={{ color: "var(--ac-muted)" }}>
                Источник: Тюменский социологический мониторинг, ТИУ, 2010–2023 гг.
              </p>
            </div>
        ...
        <section id="sources" className="scroll-mt-20">
          ...
          <ol className="space-y-3">
            {[
              ...
              "Шафранов-Куцев Г. Ф. Современный университет в условиях регионализации высшего образования. — Тюмень: ТИУ, 2003.",
              ...
              "Шафранов-Куцев Г. Ф. Регион и его социокультурная идентичность. — Тюмень: ТИУ, 2015.",
              ...
              "Тюменский социологический мониторинг / НИЛ региональных социальных исследований ТИУ. — Тюмень: ТИУ, 2023.",
      ...
      <footer className="mt-16 bg-white" style={{ borderTop: "1px solid var(--ac-border)" }}>
        <div className="max-w-4xl mx-auto px-6 py-5 flex flex-col sm:flex-row justify-between items-center gap-2 text-xs" style={{ color: "var(--ac-muted)" }}>
          <p>Гниденко П. А. · Группа ПИНб-25-1 · ТИУ · 2026</p>
